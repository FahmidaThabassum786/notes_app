...
public class NotesListAdapter extends RecyclerView.Adapter<NotesViewHolder> {
    ...
    public NotesListAdapter(Context context, List<Notes> notes, NotesClickListener listener) {
        ...
        this.list = (notes != null) ? notes : new ArrayList<>();
        this.listener = listener;
    }

    public NotesListAdapter(List<Notes> notes, MainActivity mainActivity) {
    }
    ...
    public void filterList(List<Notes> filteredList) {
        this.list = (filteredList != null) ? filteredList : new ArrayList<>();
